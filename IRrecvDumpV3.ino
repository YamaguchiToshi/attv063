...
ATOM LiteにM5Stack用赤外線送受信ユニットを取り付けて赤外線信号を観察するため，
ATティービーの配信では以下の3点を変更しています．

- Arduino.hではなくM5Atom.hをインクルード
- 赤外線センサーがつながっているGPIOのピン番号（kRecvPin）を「32」に
- setup()内に M5.begin(true, false, false);　を追加して初期化
